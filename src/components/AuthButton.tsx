  ...
  return (
    <>
      <div
        ...
        className="  grid h-screen w-screen mt-5 place-items-centerbackdrop-blur-sm transition-opacity duration-300"
      >
        <div
          data-dialog="sign-in-modal"
          className="relative mx-auto w-full max-w-[24rem]  rounded-lg overflow-hidden shadow-sm"
        >
        <h2 className="text-center p-2 md:text-2xl" >Login | SignUp</h2>
